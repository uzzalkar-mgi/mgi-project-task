...
export function SearchBar() {
    ...
    return (
        <div ref={boxRef} className="relative w-full">
            <div className="flex h-9 items-center gap-2.5 rounded-full bg-white px-4 text-slate-600 shadow-sm ring-1 ring-black/5 transition focus-within:ring-2 focus-within:ring-brand-300">
